...
Proposers are encouraged to include the following sections within Connext Improvement Proposals:
...
* **Steps to Implement** - The steps to implement the CIP, including associated costs, manpower, and other resources for each step where applicable. CIPs that involve transactions with third parties (such as grants) will need to ensure that applicable legal documentation and procedures are also included.
* **Timeline** - Relevant timing details, including but not limited to start date, milestones, and completion dates.
* **Overall Cost** - The total cost to implement the CIP. The overall cost section should include a breakdown of the total cost of the CIP, including any associated costs for each step where applicable. Consider both fixed costs and recurring costs.
